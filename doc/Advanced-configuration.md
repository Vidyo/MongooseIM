...
* **host_config** - Configuration options that need to be different for a specific XMPP domain. May contain the following subsections: **auth**, **modules**, **shaper**, **acl**, **access**.
